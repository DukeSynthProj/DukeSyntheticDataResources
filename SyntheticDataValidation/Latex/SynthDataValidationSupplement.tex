...
\begin{figure}[h!]
    \centering
    \includegraphics[width=6.5in, trim={0 0.8in 0 1in}, clip]{JdFDIBBSBasicPayDistribution.png}
...
THE RISE OF GRADE IN THE FED GOVT:  OCCUPATIONAL CATEGORY DISTRIBUTION  \\
...
THE RISE OF GRADE IN THE FED GOVT:  OCCUPATIONAL CATEGORY SWITCHERS, AGE\\
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=6in, trim={0 0 0 1.5in}, clip]{OccCatTransitionVsNonTransAllPayPlansAge.png}
...
THE RISE OF GRADE IN THE FED GOVT:  OCCUPATIONAL SWITCHERS, EDUCATION\\
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=6in, trim={0 0 0 1.5in}, clip]{OccCatTransitionVsNonTransAllPayPlansEd.png}
