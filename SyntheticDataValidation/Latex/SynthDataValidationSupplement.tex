...
\begin{itemize}
    ...
    \item A small proportion of year, agency and year, agency, occupation combinations appearing in the authentic data do not appear in the synthetic data.  Although the synthetic data do not generate new agency, occupation combinations within any year, career trajectories (multiple year agency, occupation sequences) are created that do not appear in the authentic data.
\end{itemize}
